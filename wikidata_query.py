...
async def main():
    ...
    print(f"Will process {len(quarters_to_process)} remaining quarters")
    ...
    if final_failures:
        print(f"\nFinal failed quarters after retries ({len(final_failures)}): {final_failures}")
    else:
